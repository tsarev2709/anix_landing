...
const routes = [
  ...
  { path: '/cases/hemotech-ai/', marker: 'class="case-page"' },
  { path: '/cases/tpes/', marker: 'class="case-page"' },
  { path: '/cases/mfti-endowment/', marker: 'class="case-page"' },
  { path: '/cases/mosfarma/', marker: 'class="case-page"' },
  { path: '/cases/multon-partners/', marker: 'class="case-page"' },
