...
const routes = [
  ...
  { path: '/cases/hemotech-ai/', marker: 'class="case-page"', extraMarker: 'Hemotech AI' },
  { path: '/cases/tpes/', marker: 'class="case-page"', extraMarker: 'ТПЭС' },
  { path: '/cases/mfti-endowment/', marker: 'class="case-page"', extraMarker: 'Эндаумент-фонд МФТИ' },
  { path: '/cases/mosfarma/', marker: 'class="case-page"', extraMarker: 'Мосфарма' },
  { path: '/cases/multon-partners/', marker: 'class="case-page"', extraMarker: 'Мултон Партнерс' },
...
function waitForServer(timeoutMs = 15000) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const retry = () => {
      if (Date.now() - startedAt > timeoutMs) { reject(new Error(`Static server did not become ready within ${timeoutMs}ms`)); return; }
