...
const slipLessons = [
  'slip-video-1','slip-text-1','slip-question-1','slip-video-2','slip-text-2','slip-question-2','slip-video-3','slip-text-3','slip-question-3','slip-video-4','slip-text-4','slip-question-4','slip-video-5','slip-text-5',
];
const electricalLessons = [
  'el-video-1','el-text-1','el-question-1','el-video-2','el-text-2','el-question-2','el-video-3','el-text-3','el-question-3','el-video-4','el-text-4','el-question-4','el-video-5','el-text-5',
];
...
const routes = [
  ...
  'hse/mvp/showcase/specialist','hse/mvp/showcase/admin','hse/mvp/showcase/request-course','hse/mvp/showcase/integrations','hse/mvp/showcase/support',
