...
const brandDescription =
  'Anix Studio — анимационная студия для сложных продуктов. Создаёт медицинскую анимацию, видео по охране труда, цифровых маскотов и визуальные системы для фармы, MedTech, B2B-продуктов и мероприятий.';
