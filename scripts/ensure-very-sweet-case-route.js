...
config.routes[routePath] = {
  ...
  sections: [
    {
      heading: 'Задача: оживить рецепт',
      body: 'Сториборд, персонажи, локации и минута экранного действия должны были превратиться в анимационный фрагмент, пригодный для дальнейшей студийной работы.',
    },
    {
      heading: 'Визуальная консистентность',
      body: 'Главным ограничением было сохранить узнаваемость персонажей, пропорции, мимику, цветовой характер и внутреннюю логику уже созданного визуального мира.',
    },
    {
      heading: 'Production thinking',
      body: 'ANIX собрала AI-пайплайн, дорабатывала фрагменты, контролировала движение и решала проблему нежелательного motion blur.',
    },
  ],
  links: [
