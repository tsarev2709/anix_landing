...
export const hseBenefits = [
  {
    ...
    description:
      'Один персонаж связывает инструкции, плакаты, экраны и обучение в единую визуальную систему, где каждый новый материал узнаваем и не требует перерисовки с нуля.',
