...
const services = [
  {
    title: 'Explainer-видео для B2B',
    text: 'Когда продукт классный, но его приходится объяснять слишком долго. Собираем историю, где проблема, решение и польза считываются без мучительной экскурсии по презентации.',
    icon: Workflow,
  },
  {
    title: 'Фарма, MedTech и biotech',
    text: 'Механизмы действия, доказательная база, маскоты препаратов, материалы для врачей и конференций. Тут нельзя просто красиво. Тут надо не наврать.',
    icon: Pill,
  },
  {
    title: 'Охрана труда и HSE',
    text: 'Правила безопасности, onboarding, Life Saving Rules, QR-сценарии и кампании для сотрудников. Чтобы человек не просто пролистал инструкцию, а заметил риск.',
    icon: HardHat,
  },
  {
...
const mainCases = [
  ...
  },
  {
    ...
    category: 'HSE / Life Saving Rules',
...
const reasons = [
  {
    number: '01',
    title: 'Сначала смысл',
    text: 'Разбираемся, кто смотрит, что он уже знает, где он сопротивляется и какую мысль должен унести. Без этого ролик легко превращается в доставку пикселей на дом.',
  },
  {
    number: '02',
  ...
  {
    number: '03',
    title: 'Потом production',
    text: 'AI-инструменты ускоряют производство, но не отменяют вкус, режиссуру, монтаж, научную проверку и человеческую ответственность за результат.',
  },
];
...
const processSteps = [
  ...
  {
    title: 'Собираем стиль и animatic',
    text: 'Показываем визуальный язык, кадры, ритм и логику ролика до большого производства.',
  },
  {
    title: 'Производим',
    text: 'Генерим, рисуем, анимируем, монтируем, собираем звук и доводим до версии, которую уже можно показывать.',
  },
  {
...
const directions = [
  {
    title: 'B2B и продажи',
    text: 'Explainer-ролики, visual sales kits, демо, конференции и follow-up после первого касания.',
    href: '#cases',
    icon: Workflow,
  },
  {
    title: 'Medicine',
    text: 'Фарма, MedTech, biotech, препараты, механизмы действия, врачи, маскоты и визуальные материалы.',
    href: '/medicine/',
    icon: Stethoscope,
  },
  {
    title: 'HSE',
    text: 'Охрана труда, onboarding, Life Saving Rules, QR-сценарии, карточки, маскоты и кампании для сотрудников.',
    href: '/hse/',
    icon: ShieldCheck,
  },
  {
...
const trustChips = [
  ...
  'выпускники МФТИ',
  'бизнес-школа Сбера',
  'кейсы для фармы, HSE, MedTech и промышленного B2B',
];
    ...
    <main className="design1-test">
      ...
      <section className="d1-hero d1-container" id="top">
        <div className="d1-hero-copy">
          ...
          <h1>Сложные штуки не обязаны выглядеть как сложные</h1>
          <p className="d1-lead">
            Мы делаем ролики, маскотов, визуальные системы и лендинги для
            продуктов, которые трудно объяснить с первого раза. Фарма, MedTech,
            охрана труда, B2B, события. Короче, там, где обычная презентация уже
            устала.
          </p>
          <p className="d1-microcopy">
            Не просто генерим видео. Сначала разбираемся, кому это показывать,
            что человек должен понять и почему ему вообще не все равно.
          </p>
      ...
      <section className="d1-section" id="services">
        <div className="d1-container">
          <div className="d1-section-head">
            ...
            <h2>
              Берем сложную мысль и доводим ее до формата, который можно
              показать людям
            </h2>
            <p className="d1-section-lead">
              Иногда это ролик. Иногда маскот. Иногда серия карточек, страница,
              визуальная система или экранный контент для события. Формат
              вторичен. Сначала надо понять, где у человека ломается смысл.
            </p>
          </div>
      ...
      <section className="d1-section d1-cases" id="cases">
        <div className="d1-container">
          <div className="d1-section-head d1-section-head-row">
            <div>
              <p className="d1-eyebrow">Кейсы</p>
              <h2>
