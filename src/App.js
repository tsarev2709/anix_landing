        ...
        <div className="container">
          ...
          <div className="services-grid">
            <div className="service-card">
              ...
              <div className="service-overlay">
                <div className="case-study">
                  <h4>Кейс: Рекламная кампания для ???</h4>
                  <p>Сократили производство с 3 месяцев до 2 недель</p>
                  <div className="metrics">
                    <span>Конверсия: +27%</span>
                    <span>Экономия: 40% бюджета</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="service-card">
              ...
              <div className="service-overlay">
                <div className="case-study">
                  ...
                  <p>10 продукт-роликов за 2 недели</p>
                  <div className="metrics">
                    <span>Скорость: в 5 раз быстрее</span>
            ...
            <div className="service-card">
              ...
              <p>ИИ анализирует ваш бренд и создает стилистически точную графику</p>
              <div className="service-overlay">
                <div className="case-study">
                  <h4>Клиент: ???</h4>
                  <p>Узнаваемость бренда +63%</p>
                  <div className="metrics">
