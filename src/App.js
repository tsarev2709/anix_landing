  ...
  const testimonials = [
    {
      ...
      text: 'Запрос: объяснить SaaS для автоматизации холодовой логистики без долгих созвонов. Результат: демо-просмотры выросли на 22%, ролик включили в цепочку писем, на лендинге и в Telegram-канале.',
    ...
    },
    {
      ...
      text: 'Запрос: произвести эффект на Российском венчурном форуме и быстро прогреть делегации. Результат: конверсия встреч выросла на 35%, ролик показали на LED-экране стенда и в follow-up рассылке, собрали 12 стратегических созвонов.',
      videoThumbnail: TPES,
    ...
    },
    {
      ...
      text: 'Запрос: понятно рассказать про геймифицированную HR-платформу без участия фаундера. Результат: конверсия лендинга выросла на 18%, ролик используют на питчах, демо и в онбординге партнёров.',
    ...
    },
    {
      ...
      text: 'Запрос: собрать выпускников вокруг нового фонда и передать дух Физтеха. Результат: регистрации на мероприятие выросли на 45%, ролик транслировали на сцене выпуска и в закрытых сообществах выпускников.',
    ...
    },
    {
      id: 6,
      name: 'Алексей Лычке',
      company: 'Генеральный директор, Компания B (Куба)',
      website: 'https://companiab.cu/',
      text: 'Запрос: выйти на латиноамериканских дистрибьюторов с финтех-экосистемой и донести ценность за 40 секунд. Результат: конверсия в заявки от франчайзи выросла на 19%, ролик транслируется на интерактивных столах в шоуруме Гаваны и в онлайн-демо, помог закрыть контракт с сетью отелей.',
