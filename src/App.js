  ...
  const faqData = [
    {
      ...
      answer: 'Нейросети ускоряют визуальное производство: мы превращаем сценарий в готовую анимацию за 10 дней вместо 2–3 месяцев, не теряя в качестве. Итог: быстрее запуск, меньше бюджет, больше тестов.'
    },
    {
      question: 'Сколько стоит ваш ролик?',
      answer: 'Диапазон — от 200\u00a0000 до 1,5 млн ₽. Цены зависят от длительности, визуального уровня и задач. Мы гибкие: подходим как для стартапов, так и корпораций. В любом случае — ролик себя окупает.'
    },
    {
      question: 'Сможем ли мы вносить правки?',
      answer: 'Да. Мы закладываем итерации правок на ключевых этапах: сценарий, раскадровка, визуал. Это коллаборация, а не чёрный ящик.'
    },
    {
      question: 'Сколько времени уходит на создание ролика?',
      answer: 'Типовой цикл — 7–14 дней. Быстрее, если есть чёткое понимание задач. Работаем итерационно: сценарий — раскадровка — визуал — продакшн.'
    },
    {
      question: 'А вы делали что-то подобное в нашей отрасли?',
      answer: 'Скорее всего — да. Мы специализируемся на сложных B2B-продуктах: нейронки, биотех, промышленность, GovTech, SaaS, хардвер. Но если кейса нет — мы быстро вкапываемся и делаем ролик, который звучит с первого кадра.'
    },
    {
      question: 'Нам нужен строгий стиль, всё по брендбуку — вы сможете?',
      answer: 'Да. Работаем строго в фирменном стиле, если он есть. Если нет — подбираем стиль, который логично ляжет в вашу коммуникацию (и отдел маркетинга скажет спасибо).'
    },
    {
      question: 'Чем вы отличаетесь от обычной студии или фрилансеров?',
      answer: 'У нас нет креатива ради креатива. Мы думаем в логике продаж: ролик — это инструмент. Сценарий пишет продюсер с опытом в продажах. А продакшн строим на AI и своих автоматизациях — это быстро, гибко.'
    },
    {
      question: 'Можно ли использовать один ролик в разных каналах?',
      answer: 'Да, это наша сильная сторона. Мы сразу продумываем сценарий так, чтобы ролик работал в нескольких форматах: сайт, соцсети, питч, презентация.'
    },
    {
      question: 'Что нужно, чтобы начать?',
      answer: 'Заполнить короткий бриф — это займёт 3–5 минут. Дальше мы сами соберём всё остальное и предложим концепцию. Если ок — двигаемся.'
    }
  ];
              ...
              <div key={testimonial.id} className="testimonial-card">
                ...
                <div className="testimonial-content">
                  ...
                  <div className="testimonial-author">
                    ...
                    {testimonial.website ? (
                      <a href={testimonial.website} target="_blank" rel="noopener noreferrer">{testimonial.company}</a>
                    ) : (
