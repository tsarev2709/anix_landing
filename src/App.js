        ...
        <div className="container">
          ...
          <div className="services-grid">
            <div className="service-card">
              ...
              <p>Ценность: Меньше времени уходит на прогрев, презентации и убеждение.</p>
              <p>Для кого важно: C-level, сейлзы.</p>
              <p>Что триггерит: "Мы теряем клиентов из-за долгих обсуждений и недопонимания".</p>
            ...
            <div className="service-card">
              ...
              <p>Ценность: Видео легко тиражируется, работает на новых рынках, языках, партнёрах.</p>
              <p>Для кого важно: фаундеры, международные команды.</p>
              <p>Что триггерит: "Хочу выйти в США, но нужен контент под локаль".</p>
              <div className="service-overlay">
                <div className="case-study">
            ...
            <div className="service-card">
              ...
              <p>Ценность: Продукт визуально и эмоционально выигрывает у конкурентов.</p>
              <p>Для кого важно: маркетинг, продакты, фаундеры.</p>
              <p>Что триггерит: "На фоне других выглядим скучно, нас не запоминают".</p>
              <div className="service-overlay">
                <div className="case-study">
                  <h4>Вау эффект</h4>
            ...
            <div className="service-card">
              ...
              <div className="service-overlay">
                <div className="case-study">
                  ...
                  <p>Выделитесь на конференции и лендинге</p>
                  <div className="metrics">
                    <span>Лояльность: +18 пунктов</span>
